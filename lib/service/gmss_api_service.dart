...
class GmssApiService {
  ...
  // સઘળો ડેટા કેશ કરવા માટે
  static final Map<String, List<dynamic>> _apiCache = {};
  ...
  static Future<Map<String, dynamic>> _fetchDiamondData({
    ...
    String cacheKey = "${isLab ? 'LAB' : 'NAT'}_${shapeName ?? 'ALL'}";
    List<dynamic> dataList = [];
    int totalFromApi = 0;

    if (_apiCache.containsKey(cacheKey)) {
      dataList = _apiCache[cacheKey]!;
      ...
      try {
        final Map<String, String> queryParams = {
          'auth_key': authKey,
          'page': '1',
          'per_page': '10000', // ગમે તેટલા હોય બધા લાવી દો
        };
